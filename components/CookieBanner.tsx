    ...
    >
      <div className="mx-auto flex max-w-7xl flex-col gap-4 md:flex-row md:items-center md:justify-between md:gap-6">
        <div className="flex-1">
          <h2 id="cookie-banner-title" className="text-site-lead font-serif font-semibold text-white">
            Cookie-Einstellungen
          </h2>
          <p className="text-site-body mt-1 text-white/90">
        ...
        <div className="flex shrink-0 flex-wrap gap-3">
          <button
            ...
            className="text-site-body rounded-full border border-white/40 bg-transparent px-5 py-2.5 font-medium text-white transition-colors hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-offset-2 focus:ring-offset-sage-600"
          >
            Nur notwendige
          </button>
          <button
            type="button"
            onClick={acceptAll}
            className="text-site-body rounded-full bg-orange-500 px-5 py-2.5 font-medium text-white shadow-sm transition-colors hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-offset-2 focus:ring-offset-sage-600"
          >
            Alle akzeptieren
          </button>
        </div>
