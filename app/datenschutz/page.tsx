        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-8 space-y-8 text-brown-500/90">
            ...
            <section>
              ...
              <p className="mt-3 font-medium text-brown-600">Wie erfassen wir Ihre Daten?</p>
              <p className="mt-1 leading-relaxed">
                Ihre Daten werden zum einen dadurch erhoben, dass Sie uns diese mitteilen. Hierbei kann es sich z. B. um Daten handeln, die Sie in ein Kontaktformular eingeben. Andere Daten werden automatisch oder nach Ihrer Einwilligung beim Besuch der Website durch unsere IT-Systeme erfasst. Das sind vor allem technische Daten (z. B. Internetbrowser, Betriebssystem oder Uhrzeit des Seitenaufrufs). Die Erfassung dieser Daten erfolgt automatisch, sobald Sie diese Website betreten.
              </p>
              <p className="mt-3 font-medium text-brown-600">Wofür nutzen wir Ihre Daten?</p>
              <p className="mt-1 leading-relaxed">
                Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der Website zu gewährleisten. Andere Daten können zur Analyse Ihres Nutzerverhaltens verwendet werden. Sofern über die Website Verträge geschlossen oder angebahnt werden können, werden die übermittelten Daten auch für Vertragsangebote, Bestellungen oder sonstige Auftragsanfragen verarbeitet.
              </p>
              <p className="mt-3 font-medium text-brown-600">Welche Rechte haben Sie bezüglich Ihrer Daten?</p>
              <p className="mt-1 leading-relaxed">
              ...
              <p className="mt-3 font-medium text-brown-600">Analyse-Tools und Tools von Drittanbietern</p>
              <p className="mt-1 leading-relaxed">
            ...
            <section>
              ...
              <h3 className="mt-4 font-medium text-brown-600">Anfrage per E-Mail, Telefon oder Telefax</h3>
              <p className="mt-2 leading-relaxed">
            ...
            <section>
              ...
              <p className="mt-3 leading-relaxed">
                ...
                <a href="https://privacy.google.com/businesses/gdprcontrollerterms/" target="_blank" rel="noopener noreferrer" className="text-orange-500 hover:underline">https://privacy.google.com/businesses/gdprcontrollerterms/</a>
                {' '}und{' '}
                <a href="https://privacy.google.com/businesses/gdprcontrollerterms/sccs/" target="_blank" rel="noopener noreferrer" className="text-orange-500 hover:underline">https://privacy.google.com/businesses/gdprcontrollerterms/sccs/</a>.
              </p>
              <p className="mt-3 leading-relaxed">
              ...
              <p className="mt-3 leading-relaxed">
                ...
                <a href="https://www.dataprivacyframework.gov/participant/5780" target="_blank" rel="noopener noreferrer" className="text-orange-500 hover:underline">https://www.dataprivacyframework.gov/participant/5780</a>.
              </p>
            </section>
